...
// Begin JS library code
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(2, 0, 1, socketId);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(3, 0, 1, socketId, readyState);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(5, 0, 1, createAttributes);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(6, 0, 1, socketId, userData, callbackFunc, thread);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(7, 0, 1, socketId, userData, callbackFunc, thread);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(8, 0, 1, socketId, userData, callbackFunc, thread);
